...
// eslint-disable-next-line camelcase
  ...
  request(options, function(error, response, body) {
    ...
    console.log('UAAresponse: ',UAAresponse);
    ...
    let options = {
      method: 'POST',
      url: 'https://solar-analytics-framework.predix-analytics-ui.run.aws-usw02-pr.ice.predix.io/analytics/view/aa7bbd17-23c0-4bf1-8a53-3ddd13267f68/execution',
      headers:
      {
    ...
    console.log("before call analytics");
    request(options, function(error, response, body) {
      if (error) throw new Error(error);
      console.log(body);
    });
